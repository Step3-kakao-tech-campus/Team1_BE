...
public class BaseTest {
    ...
    public void initializeRepository() {
        ...
        Apply apply1 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime1).build();
        applies.add(apply1);
        Apply apply58 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime2).build();
        applies.add(apply58);
        Apply apply2 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime3).build();
        applies.add(apply2);
        Apply apply3 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime4).build();
        applies.add(apply3);
        Apply apply4 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime5).build();
        applies.add(apply4);
        Apply apply5 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime7).build();
        applies.add(apply5);
        Apply apply57 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime8).build();
        applies.add(apply57);
        Apply apply6 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime9).build();
        applies.add(apply6);
        Apply apply7 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime10).build();
        applies.add(apply7);
        Apply apply54 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime12).build();
        applies.add(apply54);
        Apply apply55 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime13).build();
        applies.add(apply55);
        Apply apply56 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime14).build();
        applies.add(apply56);
        Apply apply50 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime15).build();
        applies.add(apply50);
        Apply apply51 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime16).build();
        applies.add(apply51);
        Apply apply52 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime17).build();
        applies.add(apply52);
        Apply apply53 = Apply.builder().state(ApplyType.REMAIN).member(member1).worktime(worktime18).build();
        applies.add(apply53);

        Apply apply59 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime2).build();
        applies.add(apply59);
        Apply apply8 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime3).build();
        applies.add(apply8);
        Apply apply9 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime4).build();
        applies.add(apply9);
        Apply apply10 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime5).build();
        applies.add(apply10);
        Apply apply61 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime6).build();
        applies.add(apply61);
        Apply apply62 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime8).build();
        applies.add(apply62);
        Apply apply11 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime9).build();
        applies.add(apply11);
        Apply apply12 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime10).build();
        applies.add(apply12);
        Apply apply60 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime11).build();
        applies.add(apply60);
        Apply apply13 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime12).build();
        applies.add(apply13);
        Apply apply14 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime13).build();
        applies.add(apply14);
        Apply apply15 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime14).build();
        applies.add(apply15);
        Apply apply16 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime15).build();
        applies.add(apply16);
        Apply apply17 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime16).build();
        applies.add(apply17);
        Apply apply18 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime17).build();
        applies.add(apply18);
        Apply apply19 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime18).build();
        applies.add(apply19);

        Apply apply20 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime1).build();
        applies.add(apply20);
        Apply apply21 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime3).build();
        applies.add(apply21);
        Apply apply22 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime4).build();
        applies.add(apply22);
        Apply apply23 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime5).build();
        applies.add(apply23);
        Apply apply24 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime7).build();
        applies.add(apply24);
        Apply apply25 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime9).build();
        applies.add(apply25);
        Apply apply26 = Apply.builder().state(ApplyType.REMAIN).member(member3).worktime(worktime10).build();
        applies.add(apply26);
        Apply apply27 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime15).build();
        applies.add(apply27);
        Apply apply28 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime17).build();
        applies.add(apply28);
        Apply apply29 = Apply.builder().state(ApplyType.REMAIN).member(member2).worktime(worktime18).build();
        applies.add(apply29);

        Apply apply30 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime1).build();
        applies.add(apply30);
        Apply apply31 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime3).build();
        applies.add(apply31);
        Apply apply32 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime4).build();
        applies.add(apply32);
        Apply apply33 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime5).build();
        applies.add(apply33);
        Apply apply63 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime6).build();
        applies.add(apply63);
        Apply apply34 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime7).build();
        applies.add(apply34);
        Apply apply64 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime8).build();
        applies.add(apply64);
        Apply apply35 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime9).build();
        applies.add(apply35);
        Apply apply36 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime10).build();
        applies.add(apply36);
        Apply apply37 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime15).build();
        applies.add(apply37);
        Apply apply38 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime16).build();
        applies.add(apply38);
        Apply apply39 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime17).build();
        applies.add(apply39);
        Apply apply40 = Apply.builder().state(ApplyType.REMAIN).member(member4).worktime(worktime18).build();
        applies.add(apply40);

        Apply apply41 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime1).build();
        applies.add(apply41);
        Apply apply42 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime3).build();
        applies.add(apply42);
        Apply apply43 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime4).build();
        applies.add(apply43);
        Apply apply44 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime5).build();
        applies.add(apply44);
        Apply apply45 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime7).build();
        applies.add(apply45);
        Apply apply46 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime9).build();
        applies.add(apply46);
        Apply apply47 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime10).build();
        applies.add(apply47);
        Apply apply48 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime15).build();
        applies.add(apply48);
        Apply apply49 = Apply.builder().state(ApplyType.REMAIN).member(member5).worktime(worktime17).build();
        applies.add(apply49);
